    ...
    <div className="space-y-6 animate-in fade-in">
      <div>
        ...
        <p className="text-muted-foreground">
          Conecte o número usado pelos módulos habilitados da Arles Platform.
        </p>
      </div>
      ...
      <div className="max-w-md">
        <Card className="shadow-md border-border/50">
          <CardContent className="p-8 flex flex-col items-center text-center">
            {status === "loading" && (
              <>
                <Loader2 className="size-12 text-muted-foreground animate-spin mb-6" />
                ...
                {qrCode ? (
                  <>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Abra o WhatsApp no celular, toque em <strong>Dispositivos vinculados</strong>{" "}
                      e escaneie o código.
                    </p>
            ...
            {status === "error" && (
              <>
                ...
                <Button onClick={() => void requestQr()} size="lg" className="w-full">
                  Tentar novamente
                </Button>
              </>
            )}
            ...
            {status === "connected" && (
              <>
                <div className="size-20 rounded-full bg-emerald-100 flex items-center justify-center mb-6 relative">
                  <Smartphone className="size-10 text-emerald-600" />
                  <span className="absolute bottom-1 right-1 size-4 bg-emerald-500 border-2 border-white rounded-full" />
                </div>
                ...
                <div className="mt-4 mb-6 flex items-center gap-2 bg-emerald-50 border border-emerald-200 rounded-xl px-4 py-3 w-full">
                  ...
                  <p className="text-sm font-semibold text-emerald-800 text-left">
